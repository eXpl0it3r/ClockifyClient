...
using ClockifyClient.V1.Workspaces.Item.Policies.Item.Requests;
using ClockifyClient.V1.Workspaces.Item.Policies.Item.Users;
...
using System;
namespace ClockifyClient.V1.Workspaces.Item.Policies.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\workspaces\{workspaceId}\policies\{-id}
    /// </summary>
    ...
    public partial class ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::ClockifyClient.V1.Workspaces.Item.Policies.Item.Requests.RequestsRequestBuilder Requests
        {
            get => new global::ClockifyClient.V1.Workspaces.Item.Policies.Item.Requests.RequestsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The users property</summary>
        [Obsolete("")]
        public global::ClockifyClient.V1.Workspaces.Item.Policies.Item.Users.UsersRequestBuilder Users
        {
            get => new global::ClockifyClient.V1.Workspaces.Item.Policies.Item.Users.UsersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ClockifyClient.V1.Workspaces.Item.Policies.Item.ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/workspaces/{workspaceId}/policies/{%2Did}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ClockifyClient.V1.Workspaces.Item.Policies.Item.ItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/workspaces/{workspaceId}/policies/{%2Did}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::ClockifyClient.Models.PtoPolicyDtoV1?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ClockifyClient.Models.PtoPolicyDtoV1> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::ClockifyClient.V1.Workspaces.Item.Policies.Item.ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ClockifyClient.V1.Workspaces.Item.Policies.Item.ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
