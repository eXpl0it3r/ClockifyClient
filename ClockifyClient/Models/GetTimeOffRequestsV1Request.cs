...
namespace ClockifyClient.Models
{
    ...
    public partial class GetTimeOffRequestsV1Request : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::ClockifyClient.Models.GetTimeOffRequestsV1Request_statuses?>? Statuses { get; set; }
#nullable restore
#else
        public List<global::ClockifyClient.Models.GetTimeOffRequestsV1Request_statuses?> Statuses { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ClockifyClient.Models.GetTimeOffRequestsV1Request"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ClockifyClient.Models.GetTimeOffRequestsV1Request"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ClockifyClient.Models.GetTimeOffRequestsV1Request CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ClockifyClient.Models.GetTimeOffRequestsV1Request();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "statuses", n => { Statuses = n.GetCollectionOfEnumValues<global::ClockifyClient.Models.GetTimeOffRequestsV1Request_statuses>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::ClockifyClient.Models.GetTimeOffRequestsV1Request_statuses>("statuses", Statuses);
