...
namespace ClockifyClient.Models
{
    ...
    public partial class TimeOffRequestFullV1Dto : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ClockifyClient.Models.TimeOffRequestStatus? Status { get; set; }
#nullable restore
#else
        public global::ClockifyClient.Models.TimeOffRequestStatus Status { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ClockifyClient.Models.TimeOffRequestPeriodDto? TimeOffPeriod { get; set; }
#nullable restore
#else
        public global::ClockifyClient.Models.TimeOffRequestPeriodDto TimeOffPeriod { get; set; }
#endif
        /// <summary>Represents the time unit of the time off request.</summary>
        public global::ClockifyClient.Models.TimeOffRequestFullV1Dto_timeUnit? TimeUnit { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ClockifyClient.Models.TimeOffRequestFullV1Dto"/> and sets the default values.
        /// </summary>
        public TimeOffRequestFullV1Dto()
        {
        ...
        public static global::ClockifyClient.Models.TimeOffRequestFullV1Dto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ClockifyClient.Models.TimeOffRequestFullV1Dto();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetObjectValue<global::ClockifyClient.Models.TimeOffRequestStatus>(global::ClockifyClient.Models.TimeOffRequestStatus.CreateFromDiscriminatorValue); } },
                { "timeOffPeriod", n => { TimeOffPeriod = n.GetObjectValue<global::ClockifyClient.Models.TimeOffRequestPeriodDto>(global::ClockifyClient.Models.TimeOffRequestPeriodDto.CreateFromDiscriminatorValue); } },
                { "timeUnit", n => { TimeUnit = n.GetEnumValue<global::ClockifyClient.Models.TimeOffRequestFullV1Dto_timeUnit>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ClockifyClient.Models.TimeOffRequestStatus>("status", Status);
            writer.WriteObjectValue<global::ClockifyClient.Models.TimeOffRequestPeriodDto>("timeOffPeriod", TimeOffPeriod);
            writer.WriteEnumValue<global::ClockifyClient.Models.TimeOffRequestFullV1Dto_timeUnit>("timeUnit", TimeUnit);
