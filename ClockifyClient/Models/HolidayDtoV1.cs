...
namespace ClockifyClient.Models
{
    ...
    public partial class HolidayDtoV1 : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Indicates that time entries will be automatically created for this holiday.</summary>
        public bool? AutomaticTimeEntryCreation { get; set; }
...
#nullable restore
        ...
        /// <summary>Represents projectId for automatic time entry creation.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string ProjectId { get; set; }
#endif
        /// <summary>Represents taskId for automatic time entry creation.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ClockifyClient.Models.HolidayDtoV1"/> and sets the default values.
        /// </summary>
        public HolidayDtoV1()
        {
        ...
        public static global::ClockifyClient.Models.HolidayDtoV1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ClockifyClient.Models.HolidayDtoV1();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "automaticTimeEntryCreation", n => { AutomaticTimeEntryCreation = n.GetBoolValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteBoolValue("automaticTimeEntryCreation", AutomaticTimeEntryCreation);
