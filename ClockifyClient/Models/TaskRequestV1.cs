...
namespace ClockifyClient.Models
{
    ...
    public partial class TaskRequestV1 : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>Represents a task duration estimate in ISO-8601 format.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::ClockifyClient.Models.TaskRequestV1_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ClockifyClient.Models.TaskRequestV1"/> and sets the default values.
        /// </summary>
        public TaskRequestV1()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::ClockifyClient.Models.TaskRequestV1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ClockifyClient.Models.TaskRequestV1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ClockifyClient.Models.TaskRequestV1();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::ClockifyClient.Models.TaskRequestV1_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ClockifyClient.Models.TaskRequestV1_status>("status", Status);
